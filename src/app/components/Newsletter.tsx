                ...
                <div className='max-w-7xl mx-auto'>
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-8 items-center'>
                        <div>
                            ...
                            <p className='text-gray-600 dark:text-gray-300 md:w-2/3'>Get the latest update on my projects, blog posts, and tech insights
                                delivered to tour inbox.</p>
                        </div>
                        <form className='flex flex-col md:flex-row gap-4'>
                            <input type='email' placeholder='Enter your eamil' className='flex-1 px-4 py-3
                        border rounded-lg dark:text-white border-gray-300 dark:border-gray-600 bg-white text-gray-50
